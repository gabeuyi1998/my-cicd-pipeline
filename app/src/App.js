...
const carImages = [
  ...
  { src: 'https://d305p2torrydv5.cloudfront.net/Image10.JPG', alt: 'BMW 10' },
...
function App() {
  ...
  return (
    <div style={{
      ...
      <h1 style={{ color: '#007acc', marginBottom: '20px', textAlign: 'center' }}>
        Welcome to Gabriel's Web App
      </h1>
      <p style={{ fontSize: '18px', color: '#333', textAlign: 'center' }}>
        I'm a 25-year-old Senior AWS DevOps Engineer, passionate about cars, especially BMWs.
      </p>
      <div style={{
        display: 'flex',
        justifyContent: 'center',
